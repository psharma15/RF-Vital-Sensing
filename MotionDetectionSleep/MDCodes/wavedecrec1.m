function [reconstructedNcs,pCorr,pValue] = wavedecrec1(ncs,t,wName,reconstructionCoeff,dispOn)
...
nCoeff = reconstructionCoeff; % Decomposition until reconstruction level
...
if dispOn ==1
    figure
    plot(t,ncs,t,reconstructedNcs);
    title(['Ncs D',num2str(reconstructionCoeff)],'FontSize',12)
    legend('Input NCS',['NCS D',num2str(reconstructionCoeff)])
