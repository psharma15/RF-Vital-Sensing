function [ncsAmpFilt,ncsPhFilt,ncsUnfiltAmpTrunc,ncsUnfiltPhTrunc,tTrunc] = postProcess(f3db,fp,fst,data,fs,signData,varargin)
...
% where, f3db = 3dB cutoff frequency of butterworth iir hp filter
