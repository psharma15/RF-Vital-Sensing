...
<p align="center">
  ...
  * Data processing is based on training at the rest state, and detects any other motion as an outlier, while not misclassifying if the signal is weaker when a person turns. The processing is shown below.
